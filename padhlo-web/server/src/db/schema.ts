...
export const notificationTypeEnum = pgEnum('notification_type', ['practice_reminder', 'test_available', 'achievement', 'streak_alert', 'community', 'general', 'exam_result', 'practice_result', 'comment_reply', 'post_comment', 'note_shared', 'join_request']);
